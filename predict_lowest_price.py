...
df = pd.read_csv(
    "E:\\Programming Projects\\Projects\\Python\\Stock AI\\Samsung Electron\\data\\Samsung_Stock.csv")
df = pd.get_dummies(df)
df = df.fillna(df.mean())
df_corr = df.corr()
df_corr_sort = df_corr.sort_values('Low', ascending=False)
